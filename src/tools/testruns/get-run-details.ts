...
export const getRunDetailsTool = {
  ...
  description:
    ...
    'AI payloads are generated lazily — if `ai_insights` sections report status "processing"/"not_generated", poll get_ai_insights(testrun_id=...) until "completed" instead of re-calling this tool.',
  inputSchema: {
    type: "object",
    properties: {
      projectId: {
