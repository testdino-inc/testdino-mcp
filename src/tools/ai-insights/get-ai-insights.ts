...
export const getAiInsightsTool = {
  ...
  description:
    ...
    'Use the project overview to answer "what should we fix first?"; the run mode to triage one run; the case mode to get fixes for one failing test. ' +
